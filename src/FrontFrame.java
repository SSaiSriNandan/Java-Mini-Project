...
public class FrontFrame {
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(175, 10, 125, 50);
		...
		JLabel lblNewLabel_1 = new JLabel("Select the required Action that you want to perform");
		lblNewLabel_1.setBounds(45, 70, 307, 34);
